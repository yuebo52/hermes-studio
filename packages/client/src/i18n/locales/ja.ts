...
export default {
  ...
  changelog: {
    ...
    new_0_7_24_5: 'グループチャットの復旧、アバター、生成タイトル、添付ファイル付きメッセージの通知プレビューを改善 (#3107, #3135, #3132)',
    new_0_7_24_6: 'セッション単位の共有音声とモデルコンテキスト権限を追加し、App に紐付くセッション共有の認可を強化 (#3121, #3128, #3129)',
    new_0_7_24_7: 'Android のタスク通知進捗を復元し、共有セッションのメタデータと招待処理を改善 (#3122, #3123, #3127)',
