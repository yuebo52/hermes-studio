...
export default {
  ...
  changelog: {
    ...
    new_0_7_24_5: '그룹 채팅 복구, 아바타, 생성된 제목과 첨부 메시지 알림 미리보기를 개선했습니다 (#3107, #3135, #3132)',
    new_0_7_24_6: '세션별 공유 음성 및 모델 컨텍스트 권한을 추가하고 App 연결 세션 공유 인증을 강화했습니다 (#3121, #3128, #3129)',
    new_0_7_24_7: 'Android 작업 알림 진행률을 복원하고 공유 세션 메타데이터와 초대 처리를 개선했습니다 (#3122, #3123, #3127)',
