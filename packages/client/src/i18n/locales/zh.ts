...
export default {
  ...
  changelog: {
    ...
    new_0_7_24_5: '改进群聊恢复、头像、生成标题以及附件消息的通知预览 (#3107、#3135、#3132)',
    new_0_7_24_6: '新增会话级共享语音与模型上下文权限，并加强 App 绑定会话共享的授权 (#3121、#3128、#3129)',
    new_0_7_24_7: '恢复 Android 任务通知进度，并改进共享会话元数据与邀请处理 (#3122、#3123、#3127)',
